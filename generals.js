...
const GENERALS_DATA = [
    { name: '大耳备', hp: 4, skill: '仁德', avatar: '🐉', color: '#2ecc71',
      skillDesc: '出牌阶段开始时，额外摸1张牌',
      skillType: 'active', canUse: true },

    { name: '大奉先', hp: 4, skill: '无双', avatar: '⚔️', color: '#c0392b',
      skillDesc: '出牌阶段，使用【杀】无次数限制',
      skillType: 'active', canUse: true },

    { name: '孙十万', hp: 4, skill: '制衡', avatar: '👑', color: '#3498db',
      skillDesc: '出牌阶段，可弃置任意张手牌然后摸等量的牌（每回合限一次）',
      skillType: 'active', canUse: true },

    { name: '华老头', hp: 4, skill: '神医', avatar: '⚕️', color: '#f39c12',
      skillDesc: '出牌阶段，可指定一名角色回复1点生命（每回合限一次）',
      skillType: 'active', canUse: true },
    ...
    { name: '常山赵', hp: 4, skill: '龙胆', avatar: '🏹', color: '#d35400',
